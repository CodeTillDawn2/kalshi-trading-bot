...
namespace SmokehousePatterns.PatternDefinitions
{
    ...
    public class CounterattackPattern2 : PatternDefinition
    {
            ...
            bool isBullish)
        {
            ...
            if (currentPrices.Timestamp == GetBreakpointTimestamp("2024-07-22T19:00:00Z"))
            {
                Debug.WriteLine($"Breakpoint hit: Checking BeltHold_Bearish at {currentPrices.Timestamp}");
            }
