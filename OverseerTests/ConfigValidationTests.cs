...
namespace OverseerTests
{
    ...
    public class ConfigValidationTests
    {
        ...
        public void ValidateSecretsInterpolationAndKeyFileExists()
        {
            ...
            var botKeyId = configuration["Kalshi:OverseerKeyId"];
            var botKeyFile = configuration["Kalshi:OverseerKeyFile"];
            TestContext.WriteLine($"Kalshi:OverseerKeyId from config: {MaskKeyId(botKeyId)}");
            TestContext.WriteLine($"Kalshi:OverseerKeyFile from config: {botKeyFile}");
