...
namespace BacklashBot.Management
{
    ...
    public class MarketManagerService : BaseMarketManagerService
    {
        ...
        {
            _managedService = new ManagedMarketManagerService(serviceFactory, logger, scopeFactory, performanceMonitor, executionConfig, tradingConfig, centralBrainConfig, scopeManagerService, statusTrackerService, brainStatus, targetCalculationService);
            _unmanagedService = new UnmanagedMarketManagerService(serviceFactory, logger, scopeFactory, performanceMonitor, executionConfig, tradingConfig, centralBrainConfig, scopeManagerService, statusTrackerService, brainStatus, targetCalculationService);
        }
