...
namespace BacklashInterfaces.PerformanceMetrics
{
    ...
    public class BasePerformanceMonitor : IPerformanceMonitor
    {
        ...
        /// </summary>
        public virtual void RecordSpeedDialMetric(string className, string id, string name, string description, double value, string unit, string category, double? minThreshold = null, double? warningThreshold = null, double? criticalThreshold = null)
        {
        ...
        /// </summary>
        public virtual void RecordProgressBarMetric(string className, string id, string name, string description, double value, string unit, string category, double? minThreshold = null, double? warningThreshold = null, double? criticalThreshold = null)
        {
            lock (_metricsLock)
            {
                _recordedMetrics.RemoveAll(m => m.ClassName == className && m.Metric?.Name == name);
        ...
        /// </summary>
        public virtual void RecordCounterMetric(string className, string id, string name, string description, double value, string unit, string category)
        {
            lock (_metricsLock)
            {
                _recordedMetrics.RemoveAll(m => m.ClassName == className && m.Metric?.Name == name);
        ...
        /// </summary>
        public virtual void RecordTrafficLightMetric(string className, string id, string name, string description, double value, string unit, string category, double? minThreshold = null, double? warningThreshold = null, double? criticalThreshold = null)
        {
            lock (_metricsLock)
            {
                _recordedMetrics.RemoveAll(m => m.ClassName == className && m.Metric != null && m.Metric.Name == name);
        ...
        /// </summary>
        public virtual void RecordPieChartMetric(string className, string id, string name, string description, double value, double? secondaryValue, string unit, string category, double? minThreshold = null, double? warningThreshold = null, double? criticalThreshold = null)
        {
            lock (_metricsLock)
            {
                _recordedMetrics.RemoveAll(m => m.ClassName == className && m.Metric?.Name == name);
        ...
        /// </summary>
        public virtual void RecordNumericDisplayMetric(string className, string id, string name, string description, double value, string unit, string category)
        {
            lock (_metricsLock)
            {
                _recordedMetrics.RemoveAll(m => m.ClassName == className && m.Metric?.Name == name);
        ...
        /// </summary>
        public virtual void RecordBadgeMetric(string className, string id, string name, string description, double value, string unit, string category)
        {
        ...
        /// </summary>
        public virtual void RecordDisabledMetric(string className, string id, string name, string description, double value, string unit, string category)
        {
            lock (_metricsLock)
            {
                _recordedMetrics.RemoveAll(m => m.ClassName == className && m.Metric?.Name == name);
